-- Idempotent links table fix: bank transfer columns + relaxed constraints.
-- Safe to run if 003/005 were never applied or only partially applied.

-- Bank transfer columns (003)
...
-- Drop known named CHECK constraints (005)
